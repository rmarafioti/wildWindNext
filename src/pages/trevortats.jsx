  ...
  return (
    <article className={styles.tattoos}>
      ...
      <p className={styles.artistAbout}>
        During his time there, Trevor refined his technical skills and developed
        a deep appreciation for the craft. His journey has taken him around the
        world, where he&apos;s continuously honed his ability to create unique,
        custom designs. Now tattooing at Wild Wind Tattoo in Chicago, Trevor is
